...
!
If(Lbackflow)then
  allocate ( ulj(nx/2+1 ,ny,nz))    ! Array for the solid term
  Allocate (vel(3,nx,ny,nz))
  Allocate (pot_bf(nx,ny,nz))
EndIf
!..........................
!.. Arrays for Helium 4 ...
!..........................
...
If(LOrtogonal)Then
  allocate (  psi_gs(nx    ,ny,nz))    ! Array with the field
  allocate ( psi_gs1(nx    ,ny,nz))    ! Array with the field 1-step old iteration
  allocate ( psi_gs2(nx    ,ny,nz))    ! Array with the field 2-step old iteration
  allocate (psi_gsnw(nx    ,ny,nz))    ! Array with the field  (working array)
EndIf  
